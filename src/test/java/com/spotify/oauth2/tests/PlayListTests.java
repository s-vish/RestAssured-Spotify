...
@Step
    ...
    @Test(description = "Create Playlist using RequestSpecBuilder")
    ...
    @Test(description = "Create Playlist without using RequestSpecBuilder")
    ...
    @Test(description = "User should get the playlist")
