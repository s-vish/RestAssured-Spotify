...
public String getRenewTokenUri() {
        String prop = properties.getProperty("renew_token_uri");
        if (prop != null) return prop;
        else throw new RuntimeException("Property renew_token_uri is not specified in the config.properties file");
    }
